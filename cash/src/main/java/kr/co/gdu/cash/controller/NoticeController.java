...
public class NoticeController {
	...
	public String noticeList(Model model,
		...
		int navStartPage = currentPage-(currentPage%navRowPerPage)+1;	// 페이지별 시작 네이게이션 인덱스
		int navEndPage = navStartPage+navRowPerPage-1;	// 페이지별 마지막 네이게이션 인덱스
		...
		model.addAttribute("navEndPage", navEndPage);
